...
The system's frontend uses **NextJS** to provide a modern and reactive experience in desktop environments. Additionally, the backend is developed in Kotlin with support for **Gradle** as a build tool.
